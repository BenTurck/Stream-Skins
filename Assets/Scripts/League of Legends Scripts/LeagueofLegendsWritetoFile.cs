...
public class LeagueofLegendsWritetoFile : MonoBehaviour
{
	...
	public void LeagueofLegendsTicker(string s)
	{
		...
		string path = "Assets/Games/League of Legends/Ticker.txt"; // This is the directory for the text file.
	...
	public void LeagueofLegendsCaster1(string s)
	{
		...
		string path = "Assets/Games/League of Legends/Caster1.txt"; // This is the directory for the text file.
		if (!File.Exists(path)) // checks if the file exists at the path
		{
	...
	public void LeagueofLegendsCaster2(string s)
	{
		...
		string path = "Assets/Games/League of Legends/Caster2.txt"; // This is the directory for the text file.
		if (!File.Exists(path)) // checks if the file exists at the path
		{
	...
	public void LeagueofLegendsHomeGame1Toggle(bool tog)
	{
		...
		string path = "Assets/Games/League of Legends/Game1 Winner.txt";
		...
		string targetMapPath = "Assets/Games/League of Legends/";
		...
		string targetLogoPath = "Assets/Games/League of Legends/";
	...
	public void LeagueofLegendsHomeGame2Toggle(bool tog)
	{
		...
		string text2 = " Won";
		string bothinput = text1 + LeagueofLegendsHomeDDStringInput + text2;
		string path = "Assets/Games/League of Legends/Game2 Winner.txt";
	...
	public void LeagueofLegendsHomeGame3Toggle(bool tog)
	{
		...
		string text2 = " Won";
		string bothinput = text1 + LeagueofLegendsHomeDDStringInput + text2;
		string path = "Assets/Games/League of Legends/Game3 Winner.txt";
	...
	public void LeagueofLegendsHomeGame4Toggle(bool tog)
	{
		...
		string text2 = " Won";
		string bothinput = text1 + LeagueofLegendsHomeDDStringInput + text2;
		string path = "Assets/Games/League of Legends/Game4 Winner.txt";
	...
	public void LeagueofLegendsHomeGame5Toggle(bool tog)
	{
		...
		string text2 = " Won";
		string bothinput = text1 + LeagueofLegendsHomeDDStringInput + text2;
		string path = "Assets/Games/League of Legends/Game5 Winner.txt";
	...
	public void LeagueofLegendsHomeDDValue(Dropdown sender)
	{
		...
		string path = "Assets/Games/League of Legends/Home Team Name.txt"; // This is the directory for the text file.
	...
	public void LeagueofLegendsHomeSeasonRecord(string s)
	{
		...
		string path = "Assets/Games/League of Legends/Home Team Season Record.txt"; // This is the directory for the text file.
		if (!File.Exists(path)) // checks if the file exists at the path
		{
	...
	{
		string maxValue = "3";
		string path = "Assets/Games/League of Legends/Home Team Series Score.txt";
	...
	public void LeagueofLegendsHomePlayer1(string s)
	{
		...
		string path = "Assets/Games/League of Legends/Home Team Player1.txt"; // This is the directory for the text file.
		if (!File.Exists(path)) // checks if the file exists at the path
		{
	...
	public void LeagueofLegendsHomePlayer2(string s)
	{
		...
		string path = "Assets/Games/League of Legends/Home Team Player2.txt"; // This is the directory for the text file.
		if (!File.Exists(path)) // checks if the file exists at the path
		{
	...
	public void LeagueofLegendsHomePlayer3(string s)
	{
		...
		string path = "Assets/Games/League of Legends/Home Team Player3.txt"; // This is the directory for the text file.
		if (!File.Exists(path)) // checks if the file exists at the path
		{
	...
	public void LeagueofLegendsHomePlayer4(string s)
	{
		...
		string path = "Assets/Games/League of Legends/Home Team Player4.txt"; // This is the directory for the text file.
		if (!File.Exists(path)) // checks if the file exists at the path
		{
	...
	public void LeagueofLegendsHomePlayer5(string s)
	{
		...
		string path = "Assets/Games/League of Legends/Home Team Player5.txt"; // This is the directory for the text file.
		if (!File.Exists(path)) // checks if the file exists at the path
		{
	...
	public void LeagueofLegendsHomePlayer1Stats(string s)
	{
		...
		string path = "Assets/Games/League of Legends/Home Team Player1 Stats.txt"; // This is the directory for the text file.
		if (!File.Exists(path)) // checks if the file exists at the path
		{
	...
	public void LeagueofLegendsHomePlayer2Stats(string s)
	{
		...
		string path = "Assets/Games/League of Legends/Home Team Player2 Stats.txt"; // This is the directory for the text file.
		if (!File.Exists(path)) // checks if the file exists at the path
		{
	...
	public void LeagueofLegendsHomePlayer3Stats(string s)
	{
		...
		string path = "Assets/Games/League of Legends/Home Team Player3 Stats.txt"; // This is the directory for the text file.
		if (!File.Exists(path)) // checks if the file exists at the path
		{
	...
	public void LeagueofLegendsHomePlayer4Stats(string s)
	{
		...
		string path = "Assets/Games/League of Legends/Home Team Player4 Stats.txt"; // This is the directory for the text file.
		if (!File.Exists(path)) // checks if the file exists at the path
		{
	...
	public void LeagueofLegendsHomePlayer5Stats(string s)
	{
		...
		string path = "Assets/Games/League of Legends/Home Team Player5 Stats.txt"; // This is the directory for the text file.
		if (!File.Exists(path)) // checks if the file exists at the path
		{
	...
	public void LeagueofLegendsAwayDDValue(Dropdown sender)
	{
		...
		string path = "Assets/Games/League of Legends/Away Team Name.txt"; // This is the directory for the text file.
	...
	public void LeagueofLegendsAwaySeasonRecord(string s)
	{
		...
		string path = "Assets/Games/League of Legends/Away Team Season Record.txt"; // This is the directory for the text file.
		if (!File.Exists(path)) // checks if the file exists at the path
		{
	...
	{
		string maxValue = "3";
		string path = "Assets/Games/League of Legends/Away Team Series Score.txt";
	...
	public void LeagueofLegendsAwayPlayer1(string s)
	{
		...
		string path = "Assets/Games/League of Legends/Away Team Player1.txt"; // This is the directory for the text file.
		if (!File.Exists(path)) // checks if the file exists at the path
		{
	...
	public void LeagueofLegendsAwayPlayer2(string s)
	{
		...
		string path = "Assets/Games/League of Legends/Away Team Player2.txt"; // This is the directory for the text file.
		if (!File.Exists(path)) // checks if the file exists at the path
		{
	...
	public void LeagueofLegendsAwayPlayer3(string s)
	{
		...
		string path = "Assets/Games/League of Legends/Away Team Player3.txt"; // This is the directory for the text file.
		if (!File.Exists(path)) // checks if the file exists at the path
		{
	...
	public void LeagueofLegendsAwayPlayer4(string s)
	{
		...
		string path = "Assets/Games/League of Legends/Away Team Player4.txt"; // This is the directory for the text file.
		if (!File.Exists(path)) // checks if the file exists at the path
		{
	...
	public void LeagueofLegendsAwayPlayer5(string s)
	{
		...
		string path = "Assets/Games/League of Legends/Away Team Player5.txt"; // This is the directory for the text file.
		if (!File.Exists(path)) // checks if the file exists at the path
		{
			File.WriteAllText(path, LeagueofLegendsHomePlayer5Input); // sets the location to path and the contents to input inside if statement
		}
	...
	public void LeagueofLegendsAwayPlayer1Stats(string s)
	{
		...
		string path = "Assets/Games/League of Legends/Away Team Player1 Stats.txt"; // This is the directory for the text file.
		if (!File.Exists(path)) // checks if the file exists at the path
		{
	...
	public void LeagueofLegendsAwayPlayer2Stats(string s)
	{
		...
		string path = "Assets/Games/League of Legends/Away Team Player2 Stats.txt"; // This is the directory for the text file.
		if (!File.Exists(path)) // checks if the file exists at the path
		{
	...
	public void LeagueofLegendsAwayPlayer3Stats(string s)
	{
		...
		string path = "Assets/Games/League of Legends/Away Team Player3 Stats.txt"; // This is the directory for the text file.
		if (!File.Exists(path)) // checks if the file exists at the path
		{
	...
	public void LeagueofLegendsAwayPlayer4Stats(string s)
	{
		...
		string path = "Assets/Games/League of Legends/Away Team Player4 Stats.txt"; // This is the directory for the text file.
		if (!File.Exists(path)) // checks if the file exists at the path
		{
	...
	public void LeagueofLegendsAwayPlayer5Stats(string s)
	{
		...
		string path = "Assets/Games/League of Legends/Away Team Player5 Stats.txt"; // This is the directory for the text file.
		if (!File.Exists(path)) // checks if the file exists at the path
		{
			File.WriteAllText(path, LeagueofLegendsHomePlayer5StatsInput); // sets the location to path and the contents to input inside if statement
		}
